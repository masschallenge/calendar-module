...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props4 = this.props,
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_this$props4, ["view", "toolbar", "events", "style", "className", "elementProps", "date", "getNow", "length", "showMultiDayTimes", "onShowMore", "components", "formats", "messages", "culture", "timezone"]);
    ...
    var formattedEvent = function formattedEvent(events) {
      events.forEach(function (event) {
        var timeZoneDate = (0, _momentTimezone.default)(event.start_date_time).tz(timezone).format('YYYY MM DD').toString();
        var start = timeZoneDate.substring(0, 10);
        event.start = (0, _momentTimezone.default)(start, 'YYYY-MM-DD');
        event.end = (0, _momentTimezone.default)(start, 'YYYY-MM-DD');
      });
      return events;
    };
